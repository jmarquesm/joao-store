...
export const Container = createPolymorphicComponent<"div", CardProps>(styled(Card as any)<CardProps>`
...
export const Image = createPolymorphicComponent<"img", ImageProps>(styled(
  MantineImage,
  transientConfig
)<ImageProps>`
